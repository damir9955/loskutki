 ...
 *
 * Ландшафтная вёрстка растягивает дорожку на почти всю ширину — она
 * съедает заметную высоту, поэтому экрану нужно ≥600px высоты, иначе
 * карточки рынка в правой колонке становятся совсем мелкими. Все реальные
 * планшеты (iPad 744–1024 CSS-высоты в альбоме) проходят; «широкие, но
 * низкие» экраны честно получают телефонную колонку.
 *
 ...
 */
const QUERY = '(min-width: 768px) and (min-height: 600px) and (orientation: landscape)';
