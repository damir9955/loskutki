...
const DICT: Record<string, [string, string]> = {
  ...
  fr_my_code: ['Ваш ID', 'Your ID'],
  fr_my_code_h: ['передайте его другу для добавления', 'share it with a friend to connect'],
  fr_add_ph: ['ID друга', "Friend's ID"],
  fr_add_btn: ['Добавить', 'Add'],
  fr_requests: ['Заявки в друзья', 'Friend requests'],
  fr_invites: ['Приглашения в игру', 'Game invites'],
  fr_friends: ['Друзья', 'Friends'],
  fr_friends_empty: ['Пока никого — добавьте друга по ID', 'Nobody here yet — add a friend by ID'],
  fr_outgoing: ['заявка отправлена', 'request sent'],
  fr_accept: ['Принять', 'Accept'],
  fr_decline: ['Отклонить', 'Decline'],
  fr_invite_game: ['Позвать', 'Invite'],
  fr_invite_sent: ['Приглашение отправлено', 'Invite sent'],
  fr_invite_sent_d: ['Друг получил уведомление — ждём его в комнате', 'Your friend got a notification — waiting for them'],
  fr_invite_t: ['{name} зовёт играть!', '{name} invites you to play!'],
  ...
  fr_challenge_go: ['Прервать и играть', 'Quit & play'],
  fr_challenge_left: ['Осталось', 'Time left'],
  fr_challenge_went: ['{name} уже передумал — вызов отменён', '{name} changed their mind — challenge cancelled'],
  fr_play: ['Играть', 'Play'],
  fr_chat: ['Чат', 'Chat'],
  fr_chat_ph: ['Сообщение…', 'Message…'],
  fr_send: ['Отправить', 'Send'],
  fr_remove: ['Удалить', 'Remove'],
  fr_remove_confirm: ['Удалить {name} из друзей? Чат сохранится.', 'Remove {name} from friends? Chat history is kept.'],
  fr_online: ['в сети', 'online'],
  fr_offline: ['не в сети', 'offline'],
  fr_vs: ['Игры {g} · Побед {w}', 'Games {g} · Wins {w}'],
  fr_bad_code: ['ID не найден — проверьте написание', 'ID not found — check the spelling'],
  fr_self: ['Это ваш собственный ID', 'That is your own ID'],
  fr_already: ['Уже в друзьях', 'Already friends'],
  fr_toomany: ['Слишком много друзей', 'Too many friends'],
  fr_not_friends: ['Вы больше не друзья', 'You are no longer friends'],
  fr_inroom: ['Сначала завершите текущую партию', 'Finish your current game first'],
  fr_room_gone: ['Комната уже недоступна', 'The room is no longer available'],
  fr_sent: ['Заявка отправлена', 'Request sent'],
  fr_sent_d: ['Друг увидит заявку в разделе «Друзья»', 'Your friend will see it in the Friends section'],
  fr_now_friends: ['Вы теперь друзья!', 'You are now friends!'],
  fr_now_friends_d: ['Зовите на битву прямо из списка друзей', 'Invite them to play right from the friends list'],
  fr_new_req: ['Новая заявка в друзья', 'New friend request'],
  fr_new_req_d: ['от {name} — откройте «Друзья»', 'from {name} — open Friends'],
  fr_new_msg: ['Сообщение от {name}', 'Message from {name}'],
  fr_removed_you: ['{name} удалил вас из друзей', '{name} removed you from friends'],
  fr_unavailable_t: ['Друзья доступны только в сети', 'Friends are available online only'],
  fr_unavailable_d: ['Подключитесь к интернету и откройте раздел снова', 'Connect to the internet and open this section again'],
  fr_add_friend: ['в друзья', 'add friend'],
  ...
  set_server_h: [
    'адрес из Deno Deploy, например https://имя.deno.net',
    'address from Deno Deploy, e.g. https://name.deno.net',
  ],
